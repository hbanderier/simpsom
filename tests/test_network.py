    ...
    def test_som(
        ...
        if self.BUILD_TRUTH:
            shutil.copyfile(
                ...
                os.path.join(
                    Parameters.truth_path, "trained_som_{}.npy".format(hashed_name)
                ),
            )
        ...
        if plotall:
            ...
            assert os.path.isfile(
                os.path.join(Parameters.output_path, "som_feature_1.png")
            )

            net.plot_map_by_difference(show=False, print_out=True, returns=False)
            assert os.path.isfile(
                os.path.join(Parameters.output_path, "som_difference.png")
            )

            net.plot_projected_points(
                net.project_onto_map(data),
                project=False,
                jitter=True,
                show=False,
                print_out=True,
            ...
            assert os.path.isfile(
                os.path.join(Parameters.output_path, "som_projected.png")
            )

            net.plot_projected_points(
                data,
                color_val=net.differences,
                project=True,
                jitter=True,
                show=False,
                print_out=True,
            ...
            assert os.path.isfile(
                os.path.join(Parameters.output_path, "som_projected_2.png")
            )
            ...
            labs, _ = net.cluster(
                ...
                file_name="som_clusters_{}.npy".format(hashed_name),
                **clus_kwargs
            )
            assert os.path.isfile(
                os.path.join(
                    Parameters.output_path, "som_clusters_{}.npy".format(hashed_name)
                )
            )
            assert os.path.isfile(
                os.path.join(
            ...
            if self.BUILD_TRUTH:
                shutil.copyfile(
                    ...
                    os.path.join(
                        Parameters.truth_path, "som_clusters_{}.npy".format(hashed_name)
                    ),
                )
                ...
                shutil.copyfile(
                    ...
                    os.path.join(
                        Parameters.truth_path,
                        "som_projected_{}.npy".format(hashed_name),
                    ),
                )
            ...
            assert os.path.isfile(
                os.path.join(Parameters.output_path, "som_clusters.png")
            )
            ...
            if early_stop is not None:
                ...
                assert os.path.isfile(
                    os.path.join(Parameters.output_path, "som_convergence.png")
                )
